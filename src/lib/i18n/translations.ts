...
export const TRANSLATIONS: Record<Language, TranslationDictionary> = {
  EN: {
    nav: {
      ...
      about: "About",
      contact: "Contact",
      bookConsultation: "Book a Free meeting",
    ...
    footer: {
      ...
      address: "5520 Summer Ave #102, Memphis, TN 38134",
    ...
    common: {
      ...
      notSureWhereToStartDesc: "You don't need to have everything figured out before contacting us. Book a free meeting and we'll help you organize the path forward.",
  ...
  ES: {
    nav: {
      ...
      about: "Nosotros",
      contact: "Contacto",
      bookConsultation: "Reservar una Reunión Gratuita",
  ...
  AR: {
    nav: {
      ...
      about: "من نحن",
      contact: "اتصل بنا",
      bookConsultation: "احجز اجتماعاً مجانياً",
